    ...
    */
    ...
    //ESSE AQUI NÃO PASSA PQ AS INFORMAÇÕES ESTÃO ERRADAS!
     ...
     public void TestarAvalicaoFeminina() {        
         ...
         Pessoa p3 = new Pessoa(1.00, 20, "f");
     ...
     */
     ...
     public void TestarAvalicaoFemininaS() {        
        Pessoa p1 = new Pessoa(1.70, 60, "F");
        assertTrue(p1.avaliacao() == "Você está muito bem! Continue assim!"); //20,8

        Pessoa p3 = new Pessoa(1.54, 100, "F"); //42,2
        assertTrue(p3.avaliacao() == "Você está Obeso. Procure o acompanhamento de um nutricionista e realizar mais atividades físicas!");

        Pessoa p2 = new Pessoa(2.90, 130, "F"); //15,5
        assertTrue(p2.avaliacao() == "Você está abaixo do peso recomendado.");
        
        Pessoa p6 = new Pessoa(1.70, 77, "f"); //26,6
        assertTrue(p6.avaliacao() == "Você está acima do peso recomendado. Cuidado!");    
      }
     
     //VERIFICA SE AS MSGS ENTÃO CORRETAS
     @Test
     public void TestarAvalicaoMasculinoS() {        
        Pessoa p1 = new Pessoa(1.70, 60, "M");
        assertTrue(p1.avaliacao() == "Você está muito bem! Continue assim!"); //20,8

        Pessoa p3 = new Pessoa(1.54, 100, "m"); //42,2
        assertTrue(p3.avaliacao() == "Você está Obeso. Procure o acompanhamento de um nutricionista e realizar mais atividades físicas!");

        Pessoa p2 = new Pessoa(1.80, 60, "m"); //18,5
        assertTrue(p2.avaliacao() == "Você está abaixo do peso recomendado.");
        
        Pessoa p6 = new Pessoa(1.70, 77, "M"); //26,6
        assertTrue(p6.avaliacao() == "Você está acima do peso recomendado. Cuidado!");    
      }
